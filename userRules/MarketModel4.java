 ...
 * 
 */
public class MarketModel4 extends IntegerRuleTemplate
{
	...
	private static final String RULE_NAME = "Market Model 4";
	...
	// //
	// private static double news[];
	//	
	// //
	// private static int linkedStatesOld[];
	//	
	// //
	// private static int linkedStatesNew[];
	//	
	// //
	 ...
	 */
	public MarketModel4(boolean minimalOrLazyInitialization)
	{
...
//				System.out.println(minNews + " Min");
		...
		if (socialForce == null || socialForceLocalCopy == null
				|| MarketModel4.numStates != numStates)
		{
			// so we can use this elsewhere
			MarketModel4.numStates = numStates;
		...
		if (currentGeneration != generation)
		{
			...
			for (int i = 0; i < numLinkedStates; i++)
			{
				for (int j = 0; j < socialForceOLLocalCopy[i].length; j++)
				{
					socialForceOLLocalCopy[i][j] += (finalNews * 5);
