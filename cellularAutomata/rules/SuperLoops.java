/*
 SuperLoops -- a class within the Cellular Automaton Explorer. 
...
/**
 * Outer totalistic rule 429 with a running average of 2.
 * 
 * @author David Bahr
 */
public class SuperLoops extends OuterTotalistic
{
	...
	private static final String RULE_NAME = "Super Loops";
	...
	private static final String BEST_RESULTS = "<html> <body><b>"
			...
			+ "Try the Fire color scheme for good contrast."
	...
	private String TOOLTIP = "<html> <body><b>"
			+ RULE_NAME
			+ ".</b> String-like loops emerging from a sea of randomness.</body></html>";

	/**
	 * Create outer totalistic rule 429 with a running average of 2.
	 * <p>
	 ...
	 */
	public SuperLoops(boolean minimalOrLazyInitialization)
	{
	 ...
	 * method should be overridden by child classes if they desire non-default
	 * behavior.
	 * 
