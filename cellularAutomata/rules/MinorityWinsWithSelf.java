/*
 MinorityWinsWithSelf -- a class within the Cellular Automaton Explorer. 
 ...
 * The cell itself is included in the calculation of which state is in the
 * minority.
 * 
 * @author David Bahr
 */
public class MinorityWinsWithSelf extends IntegerRuleTemplate
{
    // a display name for this class
    private static final String RULE_NAME = "Minority Wins (with self)";
    ...
    private static final String BEST_RESULTS = "<html> <body><b>"
        ...
        + "5 states with 80%, etc. " + leftClickInstructions
        + rightClickInstructions + "</body></html>";

    // a tooltip description for this class
    private String TOOLTIP = "<html> <body><b>"
        + RULE_NAME
        + ".</b> A person makes their current opinion match the minority of their "
     ...
     * The cell itself is included when calculating the minority.
	 * <p>
     ...
     */
    public MinorityWinsWithSelf(boolean minimalOrLazyInitialization)
    {
        super(minimalOrLazyInitialization);
    }

    /**
     * Rules for minority wins (including the cell itself).
     * 
     * @param cell
    ...
    {
        String[] folders = {RuleFolderNames.SOCIAL_FOLDER};
