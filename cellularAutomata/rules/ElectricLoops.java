/*
 ElectricLoops -- a class within the Cellular Automaton Explorer. 
...
/**
 * Outer totalistic rule 301 with a running average of 2.
 * 
 * @author David Bahr
 */
public class ElectricLoops extends OuterTotalistic
{
    // The number of states for this rule
    private static final int NUMBER_OF_STATES = 2;

    // The outer totalistic rule number
    private static int OUTER_TOTALISTIC_RULE_NUMBER = 301;

    // a display name for this class
    private static final String RULE_NAME = "Electric Loops";
    ...
    private static final String BEST_RESULTS = "<html> <body><b>"
        ...
        + "As an initial state, try a 14 by 14 filled rectangle (on a 100 by 100 "
        + "lattice).  The variety of shapes is astounding! A 25% random initial "
        + "state also works well, and produces occasional railroad tracks. Also "
        + "try a variety of symmetric initial patterns.<br><br>"
        + "Symmetric initial states produce mesmerizing pulsing patterns, while "
        + "random initial states tend to produce railroad tracks."
    ...
    private String TOOLTIP = "<html> <body><b>" + RULE_NAME
        + ".</b> Electric strings and loops that constantly change and "
        + "migrate with railroad tracks.</body></html>";

    /**
     * Create outer totalistic rule 301 with a running average of 2.
	 * <p>
     ...
     */
    public ElectricLoops(boolean minimalOrLazyInitialization)
    {
     ...
     * default, the number is 1.
     * 
     * This method should be overriden by child classes if they desire
