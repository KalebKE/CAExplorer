/*
 CyclicPulse -- a class within the Cellular Automaton Explorer. 
 ...
 * if surrounded by 4 or more neighbors with larger values. Modulos by the
 * maximum value.
 * 
 * @author David Bahr
 */
public class CyclicPulse extends RealRuleTemplate
{
	...
	private static final String RULE_NAME = "Cyclic Pulse";
	...
	private static final String BEST_RESULTS = "<html> <body><b>"
			...
			+ ".</b>"
			+ "<p> "
			+ "<b>For best results</b>, try a 50% random initial population on a 50 by "
			+ "50 lattice." + leftClickInstructions + rightClickInstructions
			+ "</body></html>";

	// a tooltip description for this class
	private String TOOLTIP = "<html> <body><b>" + RULE_NAME
			+ ".</b> Cyclic pulsing from a real-numbered rule.</body></html>";

	/**
	 * Cells always increase in value, but they increase by double the normal
	 * amount if surrounded by 4 or more neighbors with larger values. Modulos
	 ...
	 */
	public CyclicPulse(boolean minimalOrLazyInitialization)
	{
