/*
 LavaLamp -- a class within the Cellular Automaton Explorer. 
 ...
 * @author David Bahr
 */
public class LavaLamp extends CyclicCATemplate
{
	...
	private static final String RULE_NAME = "Lava Lamp";
	...
	private static final String BEST_RESULTS = "<html> <body><b>"
			...
			+ ".</b>"
			+ "<p> "
			+ "<b>For best results</b>, try 3 states and a 66% random initial state.  Also, try "
			+ "4 states and a 66% random initial state.  More states generally gives poor results. "
			+ "100 by 100 or larger lattices are most interesting."
	...
	private String TOOLTIP = "<html> <body><b>" + RULE_NAME
			+ ".</b> Lava-like bubbles from a cyclic CA.</body></html>";
	 ...
	 */
	public LavaLamp(boolean minimalOrLazyInitialization)
	{
	...
	{
		String[] lattices = {NextNearestSquareLattice.DISPLAY_NAME};
