/*
 GalacticFlashWeb -- a class within the Cellular Automaton Explorer. 
 ...
 * if surrounded by 6 or more neighbors with larger values. Modulos by the
 * maximum value.
 * 
 * @author David Bahr
 */
public class GalacticFlashWeb extends RealRuleTemplate
{
	...
	private static final String RULE_NAME = "Galactic Flash Web";
	...
	private static final String BEST_RESULTS = "<html> <body><b>"
			...
			+ ".</b>"
			+ "<p> "
			+ "<b>For best results</b>, try a 50% random initial population on a 200 by "
			+ "200 or larger square (24 next-nearest) lattice.  This gives the background "
			+ "web.  A  square (8 neighbor) lattice gives flashbulb like behavior."
	...
	private String TOOLTIP = "<html> <body><b>"
			+ RULE_NAME
			+ ".</b> Flashbulbs on a square (8 neighbor) lattice or a pulsing nebulous web on a "
			+ "square (24 next-nearest).</body></html>";

	/**
	 * Cells always increase in value, but they increase by double the normal
	 * amount if surrounded by 6 or more neighbors with larger values. Modulos
	 ...
	 */
	public GalacticFlashWeb(boolean minimalOrLazyInitialization)
	{
