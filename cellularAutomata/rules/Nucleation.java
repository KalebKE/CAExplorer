/*
 RainStorm -- a class within the Cellular Automaton Explorer. 
...
/**
 * Create a cyclic CA, inspired/discovered by Jason Rampe.
 * 
 * @author David Bahr
 */
public class Nucleation extends CyclicCATemplate
{
    // The initially displayed number of states for this rule
    private static final int NUMBER_OF_STATES = 14;

    // a display name for this class0
    private static final String RULE_NAME = "Creeping Nucleation (Spirals)";
    ...
    private static final String BEST_RESULTS = "<html> <body><b>"
        ...
        + ".</b>"
        + "<p> "
        + "<b>For best results</b>, try 14 states and a 99% random initial state.  Run the "
        + "simulation for at least 250 time steps.  "
        + "<p>Also, try "
        + "other states near 14, again with a 99% random initial state.  States between 2 and  "
        + "roughly 17 produce the most interesting results. With a larger number of states, the "
        + "probability that a cell in state i has a neighbor in state i+1 is too low, so no "
        + "patterns will nucleate.  <b>100 by 100 or larger lattices are most interesting</b>. "
    ...
    private String TOOLTIP = "<html> <body><b>"
        + RULE_NAME
        + ".</b> Colorful spirals nucleate out of initial disorder.</body></html>";

    /**
     * Create a simple cyclic CA.
	 * <p>
     ...
     */
    public Nucleation(boolean minimalOrLazyInitialization)
    {
