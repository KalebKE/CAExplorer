/*
 CollidingCyclones -- a class within the Cellular Automaton Explorer. 
...
/**
 * Create a cyclic CA rule with spirals, inspired/discovered by David Griffeath.
 * 
 * @author David Bahr
 */
public class CollidingCyclones extends CyclicCATemplate
{
	...
	private static final String RULE_NAME = "Colliding Cyclones";
	...
	private static final String BEST_RESULTS = "<html> <body><b>"
			...
			+ ".</b>"
			+ "<p> "
			+ "<b>For best results</b>, try a square (8 neighbor) lattice with 3 states and a 70% "
			+ "random initial state.  Also, try a square (24 neighbor) lattice with 6 states and "
			+ "a 95% random initial state.  Run each simulation for hundreds of time steps to see "
			+ "the formation of one giant spiral that takes over the entire lattice. <b>100 by 100 "
			+ "or larger lattices are most interesting</b>."
	...
	private String TOOLTIP = "<html> <body><b>"
			+ RULE_NAME
			+ ".</b> Produces spiraling cyclones by cycling throught every state.</body></html>";
	 ...
	 */
	public CollidingCyclones(boolean minimalOrLazyInitialization)
	{
