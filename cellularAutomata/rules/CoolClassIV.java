/*
 CoolClassIV -- a class within the Cellular Automaton Explorer. 
...
/**
 * Creates a class IV CA with 3 states corresponding to totalistic rule number
 * 1329.
 * 
 * @author David Bahr
 */
public class CoolClassIV extends Totalistic
{
	// the rule number we are simulating
	private static final BigInteger RULE_NUMBER = new BigInteger("1329");
	...
	private static final String RULE_NAME = "Cool Class IV";
	...
	private String TOOLTIP = "<html> <body><b>" + RULE_NAME
			+ ".</b> A cool example of a Wolfram class IV rule.</body></html>";

	/**
	 * Create a classIV CA with rule number 1329.
	 * <p>
	 ...
	 */
	public CoolClassIV(boolean minimalOrLazyInitialization)
	{
