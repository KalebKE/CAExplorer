/*
 PrettyClassIV -- a class within the Cellular Automaton Explorer. 
...
import cellularAutomata.rules.RuleNumber;
...
/**
 * Creates a class IV CA with 4 states corresponding to rule number
 * 27645726470709879688601734854573817858 (as outlined by the numbering scheme
 * in the RuleNumber class).
 * 
 * @author David Bahr
 */
public class PrettyClassIV extends RuleNumber
{
	// the rule number we are simulating
	private static final BigInteger RULE_NUMBER = new BigInteger(
			"27645726470709879688601734854573817858");
	...
	private static final String RULE_NAME = "Pretty Class IV";
	...
	private static final String BEST_RESULTS = "<html> <body><b>" + RULE_NAME
			...
			+ "lattice (e.g., 300 by 300)." + leftClickInstructions
			+ rightClickInstructions + "</body></html>";

	// a tooltip description for this class
	private String TOOLTIP = "<html> <body><b>"
			+ RULE_NAME
			+ ".</b> A meandering and pretty example of a Wolfram class IV rule.</body></html>";

	/**
	 * Create a classIV CA with rule number
	 * 27645726470709879688601734854573817858.
	 * <p>
	 ...
	 */
	public PrettyClassIV(boolean minimalOrLazyInitialization)
	{
