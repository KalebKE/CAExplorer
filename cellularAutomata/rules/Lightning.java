/*
 Lightning -- a class within the Cellular Automaton Explorer. 
...
/**
 * Creates a class III CA with interweaving class IV? Looks like lightning! From
 * rule number 6055785317397.
 * 
 * @author David Bahr
 */
public class Lightning extends RuleNumber
{
	...
	private static final String RULE_NAME = "Lightning";
	...
	private String TOOLTIP = "<html> <body><b>"
			+ RULE_NAME
			+ ".</b> Lightning-like shapes in an atmosphere of triangles.</body></html>";

	/**
	 * Create a lightning-like rule from rule number 6055785317397.
	 * <p>
	 ...
	 */
	public Lightning(boolean minimalOrLazyInitialization)
	{
