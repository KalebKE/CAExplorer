/*
 Rule30 -- a class within the Cellular Automaton Explorer. 
...
/**
 * The two-state CA rule 30, numbered according to Wolfram's numbering scheme.
 * 
 * @author David Bahr
 */
public class Rule30 extends WolframRuleNumber
{
	// the wolfram rule number we are simulating
	private static final int WOLFRAM_RULE_NUMBER = 30;

	// a display name for this class
	private static final String RULE_NAME = "Rule 30 (Random # Generator)";
	...
	private static final String BEST_RESULTS = "<html> <body><b>" + RULE_NAME
			...
			+ "(e.g., 200 by 200) one-dim (2 neighbor) lattice. Use the "
			+ "analysis called Randomness Test to confirm that the rule "
			+ "is chaotic and generates random numbers."
	...
	private String TOOLTIP = "<html> <body><b>" + RULE_NAME
			+ ".</b> Wolfram rule 30, which functions as a random number "
			+ "generator.</body></html>";

	/**
	 * Creates the random-number-generating rule 30.
	 * <p>
	 ...
	 */
	public Rule30(boolean minimalOrLazyInitialization)
	{
