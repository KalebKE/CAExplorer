/*
 SnowflakeMaze -- a class within the Cellular Automaton Explorer. 
...
/**
 * Outer totalistic rule 750.
 * 
 * @author David Bahr
 */
public class SnowflakeMaze extends OuterTotalistic
{
	// The number of states for this rule
	private static final int NUMBER_OF_STATES = 2;

	// The outer totalistic rule number
	private static int OUTER_TOTALISTIC_RULE_NUMBER = 750;

	// a display name for this class
	private static final String RULE_NAME = "Snowflake Maze";
	...
	private static final String BEST_RESULTS = "<html> <body><b>"
			...
			+ ".</b>"
			+ "<p> "
			+ "<b>For best results</b>, start from a single seed with a square (8 neighbor) "
			+ "or square (4 neighbor) lattice. Compare that to starting with a 50% random "
			+ "initial condition. " + leftClickInstructions
			+ rightClickInstructions + "</body></html>";

	// a tooltip description for this class
	private String TOOLTIP = "<html> <body><b>"
			+ RULE_NAME
			+ ".</b> A cross between a snowflake and a maze, generated by outer totalistic "
			+ "rule 750.</body></html>";

	/**
	 * Create outer totalistic rule 750.
	 * <p>
	 ...
	 */
	public SnowflakeMaze(boolean minimalOrLazyInitialization)
	{
