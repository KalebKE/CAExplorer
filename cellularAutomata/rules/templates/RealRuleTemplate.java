/*
 RealRuleTemplate -- a class within the Cellular Automaton Explorer. 
 ...
 * double value. (In other words, this class uses the cell state
 ...
 * @author David Bahr
 */
public abstract class RealRuleTemplate extends Rule
{
	 ...
	 */
	public RealRuleTemplate(double emptyValue, double fullValue,
	...
	public CellState calculateNewState(Cell cell, Cell[] neighbors)
	{
		...
		double doubleValue = doubleRule(cellValue, neighborArray, generation);
