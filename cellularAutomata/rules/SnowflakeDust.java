...
/**
 * Outer totalistic rule 68.
 * 
 * @author David Bahr
 */
public class SnowflakeDust extends OuterTotalistic
{
	// The number of states for this rule
	private static final int NUMBER_OF_STATES = 2;

	// The outer totalistic rule number
	private static int OUTER_TOTALISTIC_RULE_NUMBER = 68;

	// a display name for this class
	private static final String RULE_NAME = "Snowflake Dust";
	...
	private static final String BEST_RESULTS = "<html> <body><b>"
			...
			+ ".</b>"
			+ "<p> "
			+ "<b>For best results</b>, start from a single seed with a square or hexagonal lattice. "
	...
	private String TOOLTIP = "<html> <body><b>"
			+ RULE_NAME
			+ ".</b> A thin dusty snowflake generated by outer totalistic rule 68.</body></html>";

	/**
	 * Create outer totalistic rule 68.
	 * <p>
	 ...
	 */
	public SnowflakeDust(boolean minimalOrLazyInitialization)
	{
