/*
 FractalIteration -- a class within the Cellular Automaton Explorer. 
 ...
 * @author David Bahr
 */
public class FractalIteration extends ComplexRuleTemplate
{
    ...
    private static final String RULE_NAME = "Fractal No Neighbor";
    ...
    private static final String BEST_RESULTS = "<html> <body><b>"
        ...
        + "<p>"
        + "Also on the \"More Properties for Fractal\" tab, use the \"i sinh\" function with the "
        ...
        + "the Julia Set view.)"
        + "<p>"
        + "For fun, try the above settings, and make a movie (at 60 frames per second)."
        + "<p>"
    ...
    private String TOOLTIP = "<html> <body><b>"
        + RULE_NAME
        + ".</b> Generates fractals using complex numbers as values for each cell. Each cell has no neighbors. </body></html>";
     ...
     */
    public FractalIteration(boolean minimalOrLazyInitialization)
    {
