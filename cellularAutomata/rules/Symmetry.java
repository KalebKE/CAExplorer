/*
 Growth -- a class within the Cellular Automaton Explorer. 
...
/**
 * A sample rule illustrating symmetries. Used in the CA Explorer tutorial.
 * 
 * @author David Bahr
 */
public class Symmetry extends LifeExtensionsTemplate
{
    // The number of states for this rule
    private static final int NUMBER_OF_STATES = 2;

    // a display name for this class
    private static final String RULE_NAME = "Symmetry";
    ...
    private static final String BEST_RESULTS = "<html> <body><b>"
        ...
        + ".</b>"
        + "<p> "
        + "<b>For best results</b>, try a single seed on a square (8 neighbor) "
        + "lattice.  Also try rectangles and ellipses as initial states."
    ...
    private String TOOLTIP = "<html> <body><b>"
        + RULE_NAME
        + ".</b> Produces pretty symmetries from symmetric initial states.</body></html>";
     ...
     */
    public Symmetry(boolean minimalOrLazyInitialization)
    {
