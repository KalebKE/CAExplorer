/*
 MajorityWins -- a class within the Cellular Automaton Explorer. 
 ...
 * not included when counting the majority.
 * 
 * @author David Bahr
 */
public class MajorityWins extends IntegerRuleTemplate
{
    // a display name for this class
    private static final String RULE_NAME = "Majority Wins";
    ...
    private static final String BEST_RESULTS = "<html> <body><b>"
        ...
        + "and 5 states with 80%, etc. Watch as one political party slowly swallows the "
    ...
    private String TOOLTIP = "<html> <body><b>"
        + RULE_NAME
        + ".</b> A model of decision making where a person makes their current opinion "
        + "match the majority of their neighbors' opinions.</body></html>";
     ...
     */
    public MajorityWins(boolean minimalOrLazyInitialization)
    {
        super(minimalOrLazyInitialization);
    }

    /**
     * Rule for the majority wins (excluding the cell itself).
     * 
     * @param cell
