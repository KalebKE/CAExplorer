/*
 SatansStaircase -- a class within the Cellular Automaton Explorer. 
...
/**
 * Creates a three-dimensional staircase out of triangles.
 * 
 * @author David Bahr
 */
public class SatansStaircase extends RuleNumber
{
    // the rule number we are simulating
    private static final BigInteger RULE_NUMBER = new BigInteger("4067213884");
    ...
    private static final String RULE_NAME = "Satan's Staircase";
    ...
    private static final String BEST_RESULTS = "<html> <body><b>"
        ...
        + ".</b>"
        + "<p> "
        + "<b>For best results</b>, start from a random initial state on a large "
        + "lattice (e.g., 400 by 400). A running average of 2 is particularly "
        + "effective." + leftClickInstructions + rightClickInstructions
        + "</body></html>";

    // a tooltip description for this class
    private String TOOLTIP = "<html> <body><b>" + RULE_NAME
        + ".</b> 3-D triangular fractal staircases.</body></html>";

    /**
     * Create a 3-D staircase-like rule from rule number 4067213884.
	 * <p>
     ...
     */
    public SatansStaircase(boolean minimalOrLazyInitialization)
    {
    ...
    {
        String[] lattices = {NextNearestOneDimLattice.DISPLAY_NAME};
    ...
    {
        MinMaxBigIntPair pair = new MinMaxBigIntPair(RULE_NUMBER, RULE_NUMBER);
    ...
    protected BigInteger ruleNumberToDisplay(String latticeDescription)
    {
        ...
        return new BigInteger("" + RULE_NUMBER);
    }
