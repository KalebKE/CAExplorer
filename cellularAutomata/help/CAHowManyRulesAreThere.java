/*
 CAHowManyRulesAreThere -- a class within the Cellular Automaton Explorer. 
...
/**
 * Opens a browser with the a URL containing info on how many rules are in the
 * CA Explorer.
 * 
 * @author David Bahr
 */
public class CAHowManyRulesAreThere
{
	/**
	 ...
	 */
	public CAHowManyRulesAreThere(Component parent, CAMenuBar menuBar)
	{
		...
		if(displayInBrowser)
		{
			BrowserLoader.displayURL(CAConstants.HOW_MANY_RULES_ARE_THERE_URL);
		}
		else
		{
			try
			{
				URL url = new URL(CAConstants.HOW_MANY_RULES_ARE_THERE_URL);
			...
			{
				BrowserLoader
						.displayURL(CAConstants.HOW_MANY_RULES_ARE_THERE_URL);
			}
		}
	}
}
