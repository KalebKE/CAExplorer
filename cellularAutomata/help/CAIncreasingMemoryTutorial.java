/*
 CAIncreasingMemory -- a class within the Cellular Automaton Explorer. 
...
/**
 * Opens a tutorial (browser page) for increasing memory and speed.
 * 
 * @author David Bahr
 */
public class CAIncreasingMemoryTutorial
{
    /**
     * Start the memory and speed tutorial browser.
     * 
     * @param parent
     ...
     */
    public CAIncreasingMemoryTutorial(Component parent, CAMenuBar menuBar)
    {
        ...
        if(displayInBrowser)
        {
            BrowserLoader.displayURL(CAConstants.MEMORY_AND_SPEED_TUTORIAL_URL);
        }
        else
        {
            try
            {
                // get the url
                URL url = new URL(CAConstants.MEMORY_AND_SPEED_TUTORIAL_URL);
