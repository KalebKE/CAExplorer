/*
 CAObesityTutorial -- a class within the Cellular Automaton Explorer. 
...
/**
 * Opens a "Obesity Tutorial" browser page for obesity researchers.
 * 
 * @author David Bahr
 */
public class CAObesityTutorial
{
    /**
     * Start the obesity tutorial browser.
     * 
     * @param parent
     ...
     */
    public CAObesityTutorial(Component parent, CAMenuBar menuBar)
    {
        ...
        if(displayInBrowser)
        {
            BrowserLoader.displayURL(CAConstants.OBESITY_TOUR_URL);
        }
        else
        {
            try
            {
                // get the url
                URL url = new URL(CAConstants.OBESITY_TOUR_URL);
