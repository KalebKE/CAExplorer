/*
 CARuleConstructors -- a class within the Cellular Automaton Explorer. 
...
/**
 * Opens a browser with a URL containing info on how to build constructors for
 * rules in the CA Explorer.
 * 
 * @author David Bahr
 */
public class CARuleConstructors
{
	/**
	 ...
	 */
	public CARuleConstructors(Component parent, CAMenuBar menuBar)
	{
		...
		if(displayInBrowser)
		{
			BrowserLoader.displayURL(CAConstants.CA_RULE_CONSTRUCTORS_URL);
		}
		else
		{
			try
			{
				URL url = new URL(CAConstants.CA_RULE_CONSTRUCTORS_URL);
