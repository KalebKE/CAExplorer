/*
 CAGettingStarted -- a class within the Cellular Automaton Explorer. 
...
/**
 * Creates a "getting started" browser for newbies.
 * 
 * @author David Bahr
 */
public class CAGettingStarted
{
	/**
	 * Start the getting started browser.
	 * 
	 * @param parent
	 ...
	 */
	public CAGettingStarted(Component parent, CAMenuBar menuBar)
	{
		...
		if(displayInBrowser)
		{
			BrowserLoader.displayURL(CAConstants.GETTING_STARTED_URL);
		}
		else
		{
			try
			{
				// get the url
				URL url = new URL(CAConstants.GETTING_STARTED_URL);
