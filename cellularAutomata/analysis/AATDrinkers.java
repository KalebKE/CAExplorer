 ...
 * @author David Bahr
 */
public class AATDrinkers extends Analysis implements ActionListener
{
	...
	private static final String ANALYSIS_NAME = "AATDrinkers";
	 ...
	 */
	public AATDrinkers(boolean minimalOrLazyInitialization)
	{
	...
	protected void analyze(Lattice lattice, Rule rule, int generation)
	{
				...
				&& (numberOfStates <= MAX_NUMBER_OF_STATES))
		{
			...
			while (cellIterator.hasNext())
			{
		        ...
		        //If the cell is in state 1, and one of its neighbors is in state 1,
		        //then the in the next generation the cell will be a one
