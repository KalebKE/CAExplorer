...
/**
 * Finds the percentage of each state at each generation.
 * 
 * @author David Bahr
 */
public class AATNNDrinkers extends Analysis implements ActionListener
{
	...
	private static final String ANALYSIS_NAME = "AATNNDrinkers";
	 ...
	 */
	public AATNNDrinkers(boolean minimalOrLazyInitialization)
	{
	...
	protected void analyze(Lattice lattice, Rule rule, int generation)
	{
				...
				&& (numberOfStates <= MAX_NUMBER_OF_STATES))
		{
			...
			while (cellIterator.hasNext())
			{
				...
				// You have to be in state 1, none of your neighbors can be a 1,d
				// and one of your neighbor's neighbors has to be in state 1
				if (cell.toInt() == 1 && numberOfEachState[1] == 0 && numberOfEachNeighborState[1] == 5)
				{
