...
import userRules.cellularMarketModel.math.HistoricalVolatility;
 ...
 * 
 */
public class PricingVolatilityAnalysis extends Analysis implements
		ActionListener
{
	// the maximum number of elements that will be plotted on the time series
	// plot
	private static final int MAX_NUMBER_TO_PLOT = 1000;
	...
	private static final String ANALYSIS_NAME = "Pricing Volatility Analysis";
	 ...
	 */
	public PricingVolatilityAnalysis(boolean minimalOrLazyInitialization)
	{
	...
	private JPanel createMessagePanel()
	{
		...
		AttentionPanel attentionPanel = new AttentionPanel("Pricing Volatility");
	...
	protected void analyze(Lattice lattice, Rule rule, int generation)
	{
				...
				&& (numberOfStates <= MAX_NUMBER_OF_STATES))
		{
			...
			double historicalVolatility[][] = HistoricalVolatility
					.getVolatilty(historicalPricing);
