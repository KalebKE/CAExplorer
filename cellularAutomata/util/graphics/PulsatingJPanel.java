/*
 PulsatingJPanel -- a class within the Cellular Automaton Explorer. 
...
/**
 * Creates a JPanel that pulsates. The pulsation are started with the
 * startPulsing() method.
 * 
 * @author David Bahr
 */
public class PulsatingJPanel extends JPanel
{
    /**
    ...
    /**
     * Creates a pulsating panel with the given layout manager.
     * 
     * @param layout
     *            The layout manager.
     */
    public PulsatingJPanel(LayoutManager layout)
    {
        super(layout);
