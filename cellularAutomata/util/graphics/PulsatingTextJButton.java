/*
 PulsatingJButton -- a class within the Cellular Automaton Explorer. 
 ...
 * @author David Bahr
 */
public class PulsatingTextJButton extends JButton
{
	/**
	...
	/**
	 * Creates a pulsating button with the specified text displayed on the
	 * button.
	 * 
	 * @param s
	 *            The displayed text.
	 ...
	 */
	public PulsatingTextJButton(String s, Color color)
	{
		super(s);
