 ...
 * @author David Bahr
 */
public class LogReturnsPlot extends JPanel
{
	 ...
	 */
	public LogReturnsPlot(int preferredWidth, int preferredHeight)
	{
		super();
	...
	private void drawAxesLabels(Graphics2D g2)
	{
		...
		// bump the yPos of the xLabel down by 20 so negative values
		// can be plotted without the label interfering.
		g2.drawString(xLabel, Math.round(xPos), Math.round(yPos + 20));
	}
