/*
 GuassianRandom -- a class within the Cellular Automaton Explorer. 
...
public class GuassianRandom
{
	...
	/**
	 * Generates a random number with a Guassian distribution that has the
	 ...
	 */
	public double nextGuassian(double mean, double standardDeviation)
	{
		// if X ~ N(mu, sigma^2), then aX+b = N(a mu + b, (a sigma)^2). In
		// Random's nextGuassian() method, mu = 0 and sigma = 1 which is the
